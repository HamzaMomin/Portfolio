...
function ContactUs({ isDarkBackground }) {
  ...
  return (
    <div className="flex justify-center items-center mt-12">
      <motion.div
        className={`main-container z-10 sm-max:mt-16 md-range:mt-48 sm-max:w-[350px] sm-max:h-auto md-range:w-[600px] md-range:h-auto lg-range:w-[600px] lg-range:h-auto xl-min:w-[600px] xl-min:h-auto 2xl:w-[600px] 2xl:h-auto xl-min:mt-[100px] 2xl:mt-[100px] px-6 pt-6 pb-4 bg-[#69D2E7] rounded-xl text-center border-[2px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] ${isDarkBackground ? "bg-card" : "bg-[#1e8294]"}`}
      ...
      >
        ...
        >
          ...
          <a href='https://www.linkedin.com/in/hamzamomin/' target='on_blank'><img alt='Linkedin' className='w-[60px] h-[60px] ' src='src/assets/Linkedin.png' /></a>
          <a href='https://www.upwork.com/freelancers/~01c3ec471b65026c1f' target='on_blank'><img alt='Linkedin' className='w-[60px] h-[60px] ' src='src/assets/Upwork.png' /></a>
          <a href='https://www.fiverr.com/pe/NN45wkV' target='on_blank'><img alt='Linkedin' className='w-[70px] h-[70px] ' src='src/assets/Fiverr.png' /></a>
