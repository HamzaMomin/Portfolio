    ...
    <div className="container mx-auto mt-12 flex flex-col sm:flex-col-reverse md:flex-row gap-2 lg:items-center lg:justify-center">
      ...
      <div className=" flex-1 p-4 md:justify-end lg:justify-end">
        ...
        <div className="mt-12 flex justify-center items-center gap-4 ">
          ...
          {/* Connect Button */}
          <button className="inline-block px-3 py-1.5 text-base sm:text-xl font-bold text-black bg-[#FF8000] border-2 border-black rounded-md shadow-[2px_2px_0px_#000] sm:shadow-[4px_4px_0px_#000] transition-all duration-300 scale-100 sm:scale-90 hover:bg-[#FF8000] hover:text-white hover:border-black hover:scale-105 active:bg-yellow-300 active:shadow-none active:translate-y-1 ">
            Let's Connect
          </button>
        </div>
