...
function App() {
    ...
    return (
        <div
            className={`flex flex-col justify-between items-center gap-4 mb-6 px-4 overflow-hidden w-screen h-screen ${isDarkBackground ? "bg-dot-dark" : "bg-dot-12-s-2-neutral-700"
                }`}
        >
                ...
                <button onClick={toggleBackground} className="py-2 md:pl-6">
                    {isDarkBackground ? (
                        <img
                            src={Moon}
                            alt="Moon"
                            className="w-[70px] h-[70px] sm:w-[50px] sm:h-[50px] md:w-[70px] md:h-[70px] mt-4"
                        />
                    ) : (
                        <img
                            src={Sun}
            ...
            {currentScreen === "About Me" ? (
                <MainContainer isDarkBackground={isDarkBackground} />
            ) : (
                <Projects isDarkBackground={isDarkBackground}/>
            )}

            <div className="flex justify-center items-end sm:translate-y-[20px] md:translate-y-[40px] translate-y-[-70px]">
